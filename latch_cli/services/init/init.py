...
def _gen_example_nf_tutorial(dst: Path):
    dst = dst.resolve()
    src = Path(__file__).parent / "example_nf_tutorial"
...
option_map = {
    ...
    "Nextflow Tutorial Example": _gen_example_nf_tutorial,
...
template_flag_to_option = {
    ...
    "nextflow-tutorial": "Nextflow Tutorial Example",
